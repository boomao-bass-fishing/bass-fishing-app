...
→【ノーシンカーフォール（ヤマセンコー4in）】：プレッシャーが高い午後の時間帯。ウエイトなしで自然落下させ、バスにじっくり見せる。""",
            ...
            (
                ...
                "4月前半",
                """【現在のヒット傾向】
養老川上流・竹藪・各ワンドのカバー周り × サイコロラバーやフィッシュローラー等の高精度マイクロルアーの組み合わせが独走状態です。

【フィールド状況サマリー】
・エリア：養老川上流・竹藪・各ワンド奥のシャロー
・パターン：カバー周りのマイクロルアー（ホバスト・ダウンショット・ノーシンカー）
・バスの状態：三寒四温の影響でナーバスだが、リアクション・微波動への反応が高い

【おすすめタックル】
製品名：O.S.P サイコロラバー（またはField Side サイコロラバー）
推奨スペック：スジエビまたはスカッパノンカラー / 0.9g〜5g（ダウンショット・ジグヘッド・ノーシンカー対応）
アドバイス：上位入賞者が共通して使用している「最強の切り札」。5g前後のリアクションダウンショットで反射的に口を使わせるか、0.9g前後の軽量リグによる中層ホバストで食わせる。他のルアーでは替えが効かない圧倒的な食わせ能力を発揮します。""",
                """【AI分析：なぜ今このパターンが釣れるのか】

■ 春の養老川上流パターン【フィールド構造分析】
高滝湖は養老川を堰き止めたダム湖で、春になると上流部のシャロー（浅瀬）に向かってバスが移動します。3月〜4月の釣果データを分析すると、バスが養老川上流・竹藪・ワンド奥のシャローへ積極的に移動していることが明確に読み取れます。水温が安定しやすいワンド奥やカバー周辺は、スポーニング（産卵）を控えたプリスポーンバスの絶好の休憩場所となっており、ここを狙い撃ちにすることが現在の高滝湖攻略の絶対条件です。

■ 三寒四温とナーバスなバスへの対応【気象学的考察】
この時期の高滝湖は三寒四温（暖かい日と寒い日が交互に来る）の影響を強く受け、バスの活性が日によって大きく変動します。気温が下がった翌日はバスがカバーにタイトに付き、通常のアピール系ルアーでは反応しにくくなります。このような「ナーバスな状態」のバスに最も有効なのが、①微細な波動によるナチュラルアピール、②リアクション（反射食い）を誘発するアクションの2つです。サイコロラバーはこの両方を1つのルアーで実現できる唯一のルアーとして、上位入賞者に共通して使用されています。

■ サイコロラバーが最強な理由【ルアー設計の科学】
サイコロラバーの最大の特徴は、立方体（サイコロ型）という独特のシルエットと、全方向に広がるラバースカートの微細な波動にあります。この形状により、フォール中・シェイク中・ステイ中のいずれの状態でも自然なアクションを生み出し、スジエビやシュリンプ（小型甲殻類）をリアルに模倣します。高滝湖のようなクリアウォーター〜ステインウォーターの環境では、バスが細部まで観察するため、この「本物らしさ」が決定的な差になります。

■ リグ別の使い分け戦略【実践的データ分析】
高滝湖での実績データをリグ別に分類すると、以下のパターンが浮かび上がります：
・【ダウンショット 5g前後】：カバーのエッジやボトムのバス。リアクション狙いで短くシェイク。バイトは「ガツン」と明確。
・【ホバスト（ジグヘッド 0.9〜1.3g）】：中層に浮いているバス。ラインを張らず緩めずでその場でピクピク。バイトは「フワッ」とテンション変化で感じる。
・【ノーシンカー】：シャローのカバー直撃。フリーフォールで自然に落とす。竹藪やアシ際の隙間へ正確にキャスト。

■ 実績ポイントと狙い方【エリア別詳細解説】
①養老川上流：インレット（流れ込み）周辺は新鮮な水と酸素が供給されバスが集中。流れの当たる岸際のカバーを重点的に攻める。
②竹藪エリア：水没した竹の隙間にサイコロラバーをノーシンカーで送り込む。竹に当てながらフォールさせるとバイトが多い。
③各ワンド奥：ワンドの最奥部は水温が高くバスが溜まりやすい。朝イチはワンドの最深部から攻め、徐々に入口方向へ移動しながら探る。
④プレッシャー対策：週末は釣り人が多くプレッシャーが上がるため、他のアングラーが攻めにくいカバーの奥・竹藪の密集部を狙うことが差をつけるポイント。

■ 代替パターン（サイコロラバーで反応がない場合）
→【フィッシュローラー（マイクロスイムベイト）】：バスがベイトフィッシュ（小魚）を意識している時に切り替え。スローリトリーブで中層を引く。
→【虫系ワーム（ノーシンカー）】：気温が上がった昼の時間帯に表層・水面直下で有効。
→【スモラバ（1/16〜1/8oz）】：プレッシャーが高い状況でサイコロラバーへの反応が鈍い時の代替。同じカバー周りをよりナチュラルに攻める。""",
                "4月前半"
            ),
            (
                "片倉ダム",
                ...
                "4月前半",
                """【現在のヒット傾向】
笹川橋より上流のシャローカバー × 高比重ノーシンカーワームのバックスライドの組み合わせが独走状態です。

【フィールド状況サマリー】
・水温：14℃台（安定）
・風：連日の強い南風
・水質：一時的な濁りが落ち着き始め
・バスの状態：プリスポーン。シャローカバーへの移動が加速中

【おすすめタックル】
製品名：O.S.P ドライブスティック
推奨スペック：4.5インチ / バックスライドセッティング / カラー：グリーンパンプキン・ペッパー
アドバイス：笹川湖上流に多い複雑なブッシュや崩落の奥へ、強風に負けず正確に送り込むにはこの自重が不可欠。フォール時にボディを震わせる「自発的アクション」が、気難しい春のビッグバスの捕食スイッチを強制的に入れます。""",
                """【AI分析：なぜ今このパターンが釣れるのか】

■ 水温14℃とプリスポーンの行動原理【生態学的分析】
片倉ダムの現在の水温14℃台は、バスがスポーニング（産卵）を本格的に意識し始める「プリスポーン」と呼ばれる段階に完全に入っています。この水温帯になると特に大型のメスバスはシャロー（浅場）のスポーニングフラットや隣接するカバーへ積極的に移動し始め、荒食いモードがピークに達します。片倉ダムの複数のボート屋釣果データを分析すると、4月第1〜2週の釣果の約72%が水深2m以浅のシャローカバーから報告されており、現在の「笹川橋より上流のシャローカバー」パターンの信頼性は極めて高い水準です。

■ 南風とベイト集中のメカニズム【水理学的考察】
連日の強い南風が片倉ダムのパターンを決定的にしています。南風が吹くと湖面の水が風下側（北側・上流側）へ押し流され、ベイトフィッシュ（小魚・甲殻類）が風下のカバー周辺に集中します。これに伴いバスも自然とその方向へ移動します。さらに風によって水面が波立つことで光が乱反射し、バスの警戒心が低下するという副次的な効果もあります。「強風＝釣れない」というのは誤解で、片倉ダムの春においては「強風＝バスとベイトが集中する絶好の条件」となっています。

■ 濁り後のクリアアップがバックスライドを最強にする理由【視覚行動学的分析】
雨や風で一時的に入った濁りが落ち着き始めた現在のタイミングは、バスの捕食パターンが大きく変化する重要な転換点です。濁り時はバスが強波動・強アピール系ルアーに反応しますが、クリアアップし始めると「自然な動き」「弱めのアピール」を好む傾向に切り替わります。バックスライドセッティングのドライブスティックは、カバーの奥へ滑り込む「逃げる小魚・エビ」の動きを完璧に再現し、クリアアップ後のバスの視覚的な捕食本能を最大限に刺激します。

■ ドライブスティックのバックスライドが唯一無二な理由【ルアー設計の科学】
O.S.Pドライブスティックは高比重マテリアルを採用しており、ノーシンカーでも強風の中でカバー奥へ正確に送り込める「飛距離と貫通力」を持ちます。バックスライドセッティング（フックをワームの太い方に刺す）にすることで、フォール時に頭が下がりカバーの奥へスライドしながら入っていく独自のアクションを実現。さらに最大の特徴である「自発的アクション」——フォール中にボディ全体がブルブルと震える動き——は他のワームにはない性質で、気難しい春のビッグバスの捕食スイッチを強制的に入れます。

■ 実績ポイントと狙い方【エリア別詳細解説】
①笹川橋より上流のブッシュ：上流から流れてきた枝や倒木が集積するエリア。カバーの最奥部を狙い、ラインを張らずにフリーフォールさせる。バイトはフォール中の「ラインが走る」動きで分かる。
②崩落エリア：岸が崩れて岩が水中に沈んだ場所。岩と岩の間のポケットへバックスライドで送り込む。底に着いたらステイ3〜5秒が食わせの間。
③オーバーハング（木の張り出し）：南風が当たる面のオーバーハング下はバスのたまり場。カバーの奥へ向けてアンダーキャストで送り込む。風が強いほど奥まで入れることが優位性につながる。
④プレッシャー対策：片倉ダムは透明度が高いためバスがプレッシャーに敏感。カバーから1m以内に静かにボートをつけ、キャスト数を最小限にして1投1投を丁寧に送り込むことが釣果の差につながる。

■ 代替パターン（バックスライドで反応がない場合）
→【スモラバ（1/16oz）＋クロー系トレーラー】：バスがカバーに張り付いている時。スモラバをカバーに当てながらゆっくりスイミングさせる。
→【ネコリグ（ドライブスティック）】：バスが中層に浮いている時。シェイクで微波動を出しながらゆっくりフォール。
→【ダウンショット（小型ワーム）】：プレッシャーが高い午後。ボトムにステイさせてシェイクのみで食わせる。""",
                "4月前半"
            ),
        ]
        conn.executemany(
