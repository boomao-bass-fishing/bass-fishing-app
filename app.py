    ...
    },
    {
        ...
        "patterns": [
            ...
            },
            {
                ...
                "lures": [
                    _p("メガバス ブリッツ", "メガバス ブリッツ シャロークランク バス", "クリアウォーター対応"),
        ...
        "patterns": [
            ...
            },
            {
                ...
                "lures": [
                    ...
                    _p("deps バジンクロー", "deps バジンクロー バズベイト バス", "水面炸裂のバズベイト"),
        ...
        "patterns": [
            {
                ...
                "lures": [
                    ...
                    _p("OSP HPシャッドテール", "OSP HPシャッドテール ジグトレーラー バス", "スイミングトレーラーに最適"),
            ...
            },
            {
                ...
                "lures": [
                    ...
                    _p("ジャッカル ブリッツ", "OSP ブリッツ シャロークランク バス", "ウィード際のクランキング"),
                    _p("ゲーリーヤマモト ドライブシャッド 4in", "OSP ドライブシャッド スイミング バス", "スイミングリグでも◎"),
                ],
        ...
        "patterns": [
            {
                ...
                "lures": [
                    ...
                    _p("OSP HPシャッドテール 3.5in（トレーラー）", "OSP HPシャッドテール 3.5インチ スイミングジグ トレーラー", "スイミングジグに最適"),
                    _p("ゲーリーヤマモト ドライブシャッド 4in", "OSP ドライブシャッド スイミング ウィード バス", "スイミングリグで広く探る"),
                ],
