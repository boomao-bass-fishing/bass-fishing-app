...
def init_db():
    with get_db() as conn:
        ...
        """)
        # 初期レポートデータを投入（まだ1件もない場合のみ）
        existing = conn.execute("SELECT COUNT(*) as cnt FROM fishing_reports").fetchone()
        if existing["cnt"] == 0:
            seed_data = [
                (
                    "霞ヶ浦",
                    "AI釣果分析レポート",
                    "2026-04-09",
                    "【現在のヒット傾向】土浦港・波除周辺の石積みエリア × ボトムコンタクト系リグ（ネコリグ・テキサス）の組み合わせが独走状態です。\n\n【おすすめタックル】\n・製品名：ボトムアップ ブレーバー 5.7インチ（ネコリグ）\n・推奨スペック：1.3g〜1.8gネイルシンカー / グリーンパンプキンペッパー\n・アドバイス：春の陽気で温まる石積みに潜むバスを、移動を抑えて繊細に、かつ確実に仕留めるにはこの道具が不可欠です。",
                    "春の陽気で温まりやすい石積み周辺には、スポーニング（産卵）を意識したバスやベイトが接岸します。しかし、寒暖差の残るこの時期のバスはストラクチャーにタイトに付く傾向があるため、石の隙間を丁寧に探り、ピンポイントで「食わせの間」を作れるネコリグやテキサスリグが極めて有効になります。",
                    "2026-04-09 00:00:00"
                ),
                (
                    "河口湖",
                    "AI釣果分析レポート",
                    "2026-04-09",
                    "【現在のヒット傾向】信号下・鵜の島東のシャロー × 表層系プラグの組み合わせが独走状態です。\n\n【おすすめタックル】\n・製品名：トラファルガー5（ティムコ）\n・推奨スペック：53mm / 表層系（フローティング）/ ワカサギ系カラー\n・アドバイス：産卵期のワカサギを追うバスは表層の「浮き」に敏感。本物を見切る大物を騙すには、この動きが絶対不可欠です。",
                    "水温が11度に上昇し、産卵を意識したワカサギが接岸・浮上する「表層ワカサギパターン」が本格化しています。実際に50cmクラスのビッグバスが水深2mのエリアでキャッチされており、シャローに差しした個体が水面を意識しているのは明らかです。この時期、ワカサギドーム船でも連日好釣果が出ており、ベイトの密度が非常に高いこともバスの活性を押し上げる要因となっています。",
                    "2026-04-09 00:00:00"
                ),
                (
                    "亀山湖",
                    "AI釣果分析レポート",
                    "2026-04-09",
                    "【現在のヒット傾向】本湖周辺〜よりとも島 × ジャークベイト（ミノー）の組み合わせが独走状態です。\n\n【おすすめタックル】\n・製品名：O.S.P ヴァルナ 110 SP\n・推奨スペック：11cm / 16g / 金黒やワカサギ系のアピールカラー\n・アドバイス：産卵を控えたメスが好む「止まる動き」を演出できるのが最大の特徴です。濁りの中では通常よりポーズ（静止）を長めにとることで、遠くのバスにもルアーを確実に見つけさせ、爆発的なバイトを引き出せます。",
                    "現在、亀山ダムは水温が15℃前後で安定し、スポーニング（産卵）を控えた大型バスがシャローや隣接するフラットエリアへ積極的に移動しています。直近のまとまった雨による濁りがプラスに働き、バスの警戒心が薄れる一方で、視界が悪いため「強いフラッシング」と「水押し」がバイトを誘発する必須条件となっています。特にクリアアップし始めたステインエリアでの反応が極めて良好です。",
                    "2026-04-09 00:00:00"
                ),
                (
                    "三島湖",
                    "AI釣果分析レポート",
                    "2026-04-09",
                    "【現在のヒット傾向】宿原・豊英筋上流の超シャロー × スナッグレスネコリグ（ストレートワーム）の組み合わせが独走状態です。\n\n【おすすめタックル】\n・製品名：ボトムアップ ブレーバーII 5.7インチ（スナッグレスネコリグ）\n・アドバイス：ウッドチップマットの下や岸際のカバーに対して「フリーフォール」で送り込んでください。この製品特有のシャッドテールの微波動と、スナッグレスセッティングによる高いカバー回避能力が、現在の「カバーに依存した高活性魚」を効率よく引き出します。",
                    "現在、三島湖は満水を維持しており、連日の雨の影響（雨パワー）によりバスが0.3m〜1.5mという極めて浅いレンジに供給されています。水質は澄みの状態ですが、岸際やワンド奥に形成されたウッドチップやゴミ溜まりが絶好のカバーとなっており、魚がその下に身を潜めています。水温は14〜16℃で安定しており、活性化した個体が「流れ」や「新鮮な水」を求めて上流部やカバー周辺に集まっているため、これらをタイトに、かつ根掛かりを恐れず攻められるルアーが最強の選択となります。",
                    "2026-04-09 00:00:00"
                ),
            ]
            conn.executemany(
