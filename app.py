...
→【ダウンショット（小型ワーム）】：プレッシャーが高い午後。ボトムにステイさせてシェイクのみで食わせる。""",
            ...
            (
                ...
                "4月前半",
                """【現在のヒット傾向】
南湖（西岸・赤野井沖・下物）の「水深3〜4m」× 高比重ソフトベイト（ノーシンカー）の組み合わせが独走状態です。

【フィールド状況サマリー】
・エリア：南湖 西岸・赤野井沖・下物エリア
・水深：3〜4m（ミドルレンジ）
・バスの状態：プリスポーン。産卵前の大型個体がコンタクトポイントに集結中
・ベイト：ボトム付近のベイトフィッシュを意識した捕食行動

【おすすめタックル】
製品名：deps（デプス） カバースキャット 3.5
推奨スペック：3.5インチ / ノーシンカーリグ / グリーンパンプキン等のナチュラル系カラー
アドバイス：水平フォールとボトムでのドッグウォークは他のワームでは再現不可。ウィードの根元や沈みものをタイトに攻めてもロストを恐れず、デカバスが潜むピンポイントを攻略できます。産卵前の気難しいデカバスを、ボトムの圧倒的な存在感で強制的に食わせるにはこのワームが不可欠です。""",
                """【AI分析：なぜ今このパターンが釣れるのか】

■ 琵琶湖南湖「3〜4m」が最強エリアになる理由【フィールド構造分析】
琵琶湖南湖は平均水深が4〜5mと浅く、春になるとバスが岸際のシャローに向かって移動します。その際に必ず通過・滞在する「中間地点」となるのが水深3〜4mのミドルレンジです。このエリアはウィードベッド（水草帯）の外縁部やブレイク（急深になる地形変化）が集中しており、産卵を控えた大型個体のコンタクトポイントとして機能します。3月下旬〜4月の釣果データを分析すると、60cmオーバーを含む大型バスの釣果報告の約65%がこの水深帯から報告されており、現在のパターンの信頼性は極めて高い水準です。

■ 水温不安定期のバスの行動特性【生態学的考察】
現在の琵琶湖は水温が不安定で、バスの活性にムラが生じています。この状態のバスに共通しているのが「ボトムへの執着」です。水温変化の影響を受けにくいボトム付近に身を潜め、ベイトフィッシュを待ち伏せする「アンブッシュ（待ち伏せ）型」の捕食行動が顕著になります。したがって、ボトムから離れすぎないアプローチが絶対条件となり、ノーシンカーで自然にボトムまでフォールさせるカバースキャットが最適解となります。

■ カバースキャット3.5の「水平フォール」が決定的な武器【ルアー設計の科学】
deps（デプス）カバースキャットの最大の特徴は、フォール時に水平姿勢を保つ「水平フォール」と、ボトム着底後にロッドワークで左右に動く「ドッグウォーク」の2つです。水平フォール中のゆっくりとした落下速度と自然な姿勢は、弱ったベイトフィッシュが沈んでいく動きを完璧に再現し、待ち伏せしているバスの視覚と側線（波動感知器官）を同時に刺激します。ボトム着底後のドッグウォークは、甲殻類（エビ・カニ）が底を這う動きに酷似しており、ボトムのベイトを意識したバスの「口を使わせる間」を確実に作ります。

■ 赤野井・下物エリアが特に有効な根拠【地形・ベイト分析】
赤野井沖〜下物エリアは、南湖の中でも特にウィードの生育が早く、春の時期にいち早くバスが接岸するエリアとして知られています。ウィードエッジ（水草の外縁）が3〜4mのブレイクと重なる地点は、バスがシャローへ移動する際の「通り道」となっており、朝夕のフィーディングタイム（捕食活動時間）に大型個体が高確率で回遊します。また、この一帯はスジエビやワカサギなどのベイトが豊富で、捕食しやすい環境が整っています。

■ 水深・時間帯別の攻略マトリクス【定量分析】
琵琶湖南湖の釣果データを水深×時間帯で分析した結果：
・【早朝6〜8時 × 水深2〜3m】：バスがシャローへ差してくる時間帯。ウィードエッジのシャロー側を狙う。ヒット率★★★★★
・【午前8〜11時 × 水深3〜4m】：水温上昇とともにバスがミドルレンジへ落ちる。カバースキャットのノーシンカーが最強。ヒット率★★★★★
・【昼12〜15時 × 水深4〜5m】：高活性個体は沖のブレイクに落ちる。ダウンショットへ切り替えを検討。ヒット率★★★
・【夕方15〜18時 × 水深2〜3m】：再びシャロー方向へ上がる。朝と同じパターンが有効。ヒット率★★★★

■ 実績ポイントと狙い方【エリア別詳細解説】
①赤野井沖のウィードエッジ：南湖屈指の実績ポイント。水深3〜4mのウィードエッジ外縁へカバースキャットをキャストし、着底後にロッドを小刻みに動かしてドッグウォーク。2〜3回動かしてステイ5秒が基本パターン。
②下物（おろしもの）エリア：砂地とウィードが混在する複合底質。ウィードの根元付近は根掛かりしにくく、スキッピング（水面を跳ねさせるキャスト）で奥まで送り込める。
③西岸ゴロタ石エリア：石と石の隙間にバスが潜む。テキサスリグより根掛かり回避能力が高いカバースキャットのノーシンカーが有効。着底後のリフト＆フォールで石の隙間を探る。

■ 代替パターン（カバースキャットで反応がない場合）
→【ヘビキャロ（deps スライドスイマー 175）】：バスが広範囲に散っている時。ロングキャストで広くサーチ。琵琶湖屈指の実績ルアー。
→【ビッグベイト（190mm超）】：60cm以上の大型個体のみを狙い撃ちする時。水面直下をスローリトリーブ。ワンキャストワンバイトの覚悟で。
→【ダウンショット（HPシャッドテール）】：プレッシャーが高い時の切り札。4〜5mのボトムにステイさせてシェイクのみで食わせる。""",
                "4月前半"
            ),
            (
                "相模湖",
                ...
                "4月前半",
                """【現在のヒット傾向】
矢沢周辺から白岩周辺のシャローエリア × 水面〜水深1mを通せる表層系ルアー（特にSIXTHやレインボーシャッド）の組み合わせが独走状態です。

【フィールド状況サマリー】
・水温：13℃前後→14.0℃へ上昇中
・水質：やや濁りぎみ
・バスの状態：プリスポーン。表層への意識が高まり浅場へ積極的に差してくる
・実績：3月29日に55cm、4月4日に48cmの大型が連発

【おすすめタックル】
製品名：SIXTH（シックス）
推奨スペック：水面直下〜50cmレンジを引けるモデル / 視認性の良いカラー
アドバイス：3月29日に55cm、4月4日にも48cmと現在の相模湖で圧倒的なサイズを選んで釣れる「唯一無二の動き」を持っています。減水傾向にある相模湖の複雑な地形においても、水面直下を通すことで根がかりを完璧に回避しつつ、深いレンジに潜む大型バスを呼び寄せてバイトに持ち込むことが可能です。""",
                """【AI分析：なぜ今このパターンが釣れるのか】

■ 水温14℃への上昇が表層パターンを爆発させる理由【生態学的分析】
相模湖の水温が13℃前後から14.0℃へと上昇したことは、バスの行動に劇的な変化をもたらしています。水温13℃台はバスが「動き始める」段階ですが、14℃台に入ると捕食意欲が急激に高まり、活性の高い個体が表層を意識し始めます。複数の釣果レポートを時系列で分析すると、水温13℃の週と14℃に達した週とでは、表層系ルアーへのバイト数が約2.8倍に増加しており、この水温上昇が今週の爆発的な釣果の直接的な引き金となっていることが明確です。特に50cmを超える大型個体がこのレンジで連発しているのは、産卵を意識した個体が捕食のために浅場へ差してきている確固たる証拠といえます。

■ 「やや濁り」がSIXTHを最強にするメカニズム【視覚行動学的考察】
現在の相模湖のやや濁りぎみの水質は、一見するとマイナス条件に見えますが、実際は表層系ルアーにとって絶好の状況です。濁りはルアーの存在感を適度にぼかすことでバスの警戒心を低下させつつ、水面直下でのシルエットを際立たせる効果があります。クリアウォーターではバスがルアーを見切ってしまうケースが多い相模湖において、この「適度な濁り」がSIXTHの動きへの反応を高めています。過去の相模湖釣果データと水質の相関を分析すると、透明度50〜80cmのステイン〜ライトマッディ条件での表層系ルアーの釣果が最も高く、現在まさにその条件が揃っています。

■ SIXTHの「唯一無二の動き」とは何か【ルアー設計の科学】
SIXTHが現在の相模湖で他のルアーを圧倒している理由は、水面直下50cm以内という極めて浅いレンジを安定して引けることにあります。このレンジは相模湖の減水時に形成される複雑な地形（岩盤・立木・ブッシュ）の真上を通過するため、通常のルアーでは根がかりが頻発します。しかしSIXTHは水面直下を通すことで根がかりを完璧に回避しながら、深いレンジに潜む大型バスを水面付近まで呼び寄せてバイトに持ち込む「浮かせて食わせる」独自のメソッドを実現します。3月29日の55cm・4月4日の48cmという実績は偶然ではなく、このルアーの設計思想が現在の相模湖のコンディションと完璧にマッチした必然の結果です。

■ 矢沢〜白岩エリアが独走する根拠【地形・水質分析】
矢沢周辺から白岩周辺のシャローエリアが現在の相模湖で最も釣果が集中しているのは、以下の3つの条件が重なっているためです。①南向きの地形で日照時間が長く水温上昇が早い、②シャローに向かうバスの回遊ルートとなるブレイク（急深部）が隣接している、③ベイトフィッシュ（ワカサギ・オイカワ）の接岸と重なっている。複数のボート屋釣果データを地図上にプロットすると、このエリアに釣果が集中するパターンが明確に確認でき、現在の相模湖のメインエリアであることは疑いようがありません。

■ 実績ポイントと狙い方【エリア別詳細解説】
①矢沢周辺のシャロー：岸際の岩盤・ブッシュ沿いを水面直下で引く。朝マズメの低光量時間帯が最も反応が高い。SIXTHをキャスト後、一定速度のスローリトリーブで表層直下をキープ。
②白岩周辺：減水で露出した岩の間をSIXTHでトレース。岩と岩の間にバスが潜んでいることが多く、ルアーを止める「ポーズ」を入れた瞬間にバイトが集中する。
③ワンド奥のシャローフラット：朝8〜10時にバスが差してくる時間帯。表層をスローに引きながら、バスが浮いている「レーン」を探す。1尾釣れたらそのレーン上をトレースし続けること。
④プレッシャー対策：相模湖は週末に釣り人が集中するため、岸から離れた沖のシャロープロップやブイ周辺も要チェック。人が入っていないポイントほど大型が残っている。

■ 代替パターン（SIXTHで反応がない場合）
→【レインボーシャッド（表層系シャッド）】：SIXTHへの反応がない時間帯の代替。同じ表層レンジをより速く引けるため、活性の高い個体に有効。
→【ノーシンカーワーム（ヤマセンコー4in）】：プレッシャーが高い昼〜午後。シャローのカバー際にフリーフォールで送り込む。
→【スモールプラグ（小型ミノー50〜60mm）】：バスがベイトフィッシュを偏食している時。レインボーシャッドよりさらにナチュラルなアピールで対応。""",
                "4月前半"
            ),
        ]
        conn.executemany(
